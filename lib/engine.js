  ...
  return new _bluebird2.default(function (resolve, reject) {
    ...
    switch (rule.ruleObject.condition.operation) {
      ...
      case "minlength":
        ...
        break;
      case "betweenlength":
        result = _lodash2.default.has(fact, rule.ruleObject.condition.params.value) && _lodash2.default.isString(fact[rule.ruleObject.condition.params.value]) && rule.ruleObject.condition.params.min <= fact[rule.ruleObject.condition.params.value].length <= rule.ruleObject.condition.params.max;
        if (result === false) errorMessages.push(rule.ruleObject.condition.params.message);
        break;
      case "gt":
